...
//Global variables
	...
	public static void main(String args[]){
		...
		//Locations
            ...
            loc3.setName("Gold Mine");
   	        loc3.setDesc("There are tons of gold.");
	...
	public static void setDir() {
		...
		if (currentLocale == loc0 && inventory[0].gethasItem() == false){
		 ...
		 if (currentLocale == loc2 && inventory[2].gethasItem() == false){
		 ...
		 System.out.println(itemsFromSearch);
		 ...
		 if (inventory[6].gethasItem() == true){
			 System.out.println(inventory[6].getName() + ": " + inventory[6].getDesc() + ": " + inventory[6].getAmount());
		 }
